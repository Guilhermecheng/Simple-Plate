// plates are coming from plates.js
...
plates.map((plate, i) => {
    ...
    for (var j = 0; j < plate.stars; j++) {
        ...
        star.setAttribute("src", "./src/images/Star.svg");
    ...
    time_img.setAttribute("src", "./src/images/clock.svg");
    ...
    serves_img.setAttribute("src", "./src/images/plate.svg");
    ...
    address_img.setAttribute("src", "./src/images/fast-food.svg");
